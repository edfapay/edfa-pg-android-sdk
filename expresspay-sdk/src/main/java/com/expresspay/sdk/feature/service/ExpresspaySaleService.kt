...
/**
 * SALE Service for the [com.expresspay.sdk.feature.adapter.ExpresspaySaleAdapter].
 ...
 */
interface ExpresspaySaleService {

    /**
     * Perform SALE request.
     *
     * @param url the [com.expresspay.sdk.core.ExpresspayCredential.PAYMENT_URL].
     * @param action the [com.expresspay.sdk.model.api.ExpresspayAction.SALE].
    ...
    fun sale(
        ...
        orderAmount: String,
        @NonNull
        @Size(ExpresspayValidation.Text.CURRENCY)
        ...
        @NonNull
        @Size(min = ExpresspayValidation.Card.CVV_MIN, max = ExpresspayValidation.Card.CVV_MAX)
        @Field("card_cvv2")
        cardCvv2: String,
        @NonNull
        ...
        @NonNull
        @Size(ExpresspayValidation.Text.COUNTRY)
        @Field("payer_country")
        payerCountry: String,
        @Nullable
        @Size(max = ExpresspayValidation.Text.SHORT)
