...
/**
 * RECURRING_SALE Service for the [com.edfapg.sdk.feature.adapter.EdfaPgRecurringSaleAdapter].
...
interface EdfaPgRecurringSaleService {
     ...
     * @param action the [com.edfapg.sdk.model.api.EdfaPgAction.RECURRING_SALE].
