...
package com.edfapg.sdk.model.response.base

import com.edfapg.sdk.model.response.base.error.EdfaPgError

/**
 * The base response for the [com.edfapg.sdk.core.EdfaPgSdk].
 ...
 */
sealed class EdfaPgResponse<Result> {
     ...
     */
    data class Error<Result>(val error: EdfaPgError) : EdfaPgResponse<Result>()
     ...
     */
    data class Result<Result>(val result: Result) : EdfaPgResponse<Result>()
}
