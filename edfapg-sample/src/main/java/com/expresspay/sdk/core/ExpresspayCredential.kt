...
import com.edfapg.sdk.core.EdfaPgCredential.init
...
internal object EdfaPgCredential {
     ...
     */
    private const val CLIENT_KEY = "com.edfapg.sdk.CLIENT_KEY"

    /**
     * Password for Client authentication in Payment Platform (used for calculating hash parameter).
     */
    private const val CLIENT_PASS = "com.edfapg.sdk.CLIENT_PASS"

    /**
     * URL to request the Payment Platform.
     */
    private const val PAYMENT_URL = "com.edfapg.sdk.PAYMENT_URL"
