...
/**
 * SALE Service for the [com.edfapaygw.sdk.feature.adapter.EdfaPgSaleAdapter].
 ...
 */
interface EdfaPgSaleService {

    /**
     * Perform SALE request.
     *
     * @param url the [com.edfapaygw.sdk.core.EdfaPgCredential.PAYMENT_URL].
     * @param action the [com.edfapaygw.sdk.model.api.EdfaPgAction.SALE].
    ...
    fun sale(
        ...
        orderAmount: String,
        @NonNull
        @Size(EdfaPgValidation.Text.CURRENCY)
        ...
        @NonNull
        @Size(min = EdfaPgValidation.Card.CVV_MIN, max = EdfaPgValidation.Card.CVV_MAX)
        @Field("card_cvv2")
        cardCvv2: String,
        @NonNull
        ...
        @NonNull
        @Size(EdfaPgValidation.Text.COUNTRY)
        @Field("payer_country")
        payerCountry: String,
        @Nullable
        @Size(max = EdfaPgValidation.Text.SHORT)
